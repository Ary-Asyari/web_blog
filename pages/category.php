    ...
    <?php while($row=mysqli_fetch_array($query)) {?>
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-9">
                ...
                <h5 class="card-title font-weight-bold h4 pt-3 mb-3"><a href="index.php?blog=<?php echo $row["id"] ?>"><?php echo $row["title"] ?></a></h5>
            </div>
            </div>
    <?php } ?>
<?php } ?>
    ...
    <?php if($total_page > 1) {?>
        <nav aria-label="..." class="my-5">
            <ul class="pagination justify-content-center">
                <?php if($cur_page > 1) {?>
                    <li class="page-item">
                        <a class="page-link halaman" href="index.php?page-category=<?php echo ($cur_page - 1)."&category=".$category_id?>" aria-label="Previous">
                ...
                <?php if($cur_page < $total_page) {?>
                    <li class="page-item">
                        <a class="page-link halaman" href="index.php?page-category=<?php echo ($cur_page + 1)."&category=".$category_id?>" aria-label="Next">
